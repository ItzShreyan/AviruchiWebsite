window.snacks = [
  ...
  /* ------------------------------
     HOT SNACKS (MILLET SNACKS)
  ------------------------------ */

  {
    id: "snack_millet_gavvalu",
    name: "Millet Gavvalu",
    category: "Snacks",
